...
def _get_twitter_api():
    ...
    consumer_key = getattr(settings, "TWITTER_CONSUMER_SECRET")
    # .. setting_name: TWITTER_ACCESS_TOKEN
    # .. setting_default: ''
    # .. setting_description: The access token key associated with the user that will publish the tweets.
    access_token = getattr(settings, "TWITTER_ACCESS_TOKEN")
    # .. setting_name: TWITTER_ACCESS_TOKEN_SECRET
    # .. setting_default: ''
    # .. setting_description: The access token secret associated with the user that will publish the tweets.
