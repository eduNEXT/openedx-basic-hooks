...
"""
Open edX basic hooks documentation build configuration file.
...
project = 'Open edX basic hooks'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Open edX basic hooks'
...
#
# html_title = 'Open edX basic hooks v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Demo of the hooks extensions project for the Open edX platform.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_basic_hooks'),
                os.path.join(root_path, 'openedx_basic_hooks/migrations')])
